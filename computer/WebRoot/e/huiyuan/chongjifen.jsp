...
<body>
	...
	<div class="wrap">
		<div class="cover-title">
			当前位置：<a href="<%=SystemParam.getSiteRoot() %>/e/index.jsp">首页</a> &gt;&gt; 购买积分
		</div>
	</div>
		       ...
		       <div class="main-content">
					...
					<div class="description"></div>
					 ...
					 <form name="chongzhiForm" action="<%=SystemParam.getSiteRoot() %>/admin/huiyuanmanager.do" id="chongzhiForm" method="post">
					   ...
					   <input type="hidden" name="actiontype" value="chongjifen"/>
					   <input type="hidden" name="forwardurl" value="/e/huiyuan/jifenresult.jsp"/>
						<table border="0" cellspacing="1" class="grid" cellpadding="0"
							...
							<tr>
							    ...
							    <td >
							          ...
							          <span style="font-size:24px;font-weight:800;color:#f00;">${huiyuan.jifen}分</span>
							    </td>
