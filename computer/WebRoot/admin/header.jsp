  ...
  <div class="head">
             ...
             <div class="head-account">
                             ...
                             <div class="label-text" style="padding-right:20px;color:white;">
                                <a style="font-size:18px;color:#fff;" href="<%=SystemParam.getSiteRoot()%>/e/index.jsp" target="_blank">预览前台</a>
                             </div>
                             <div class="label-text">欢迎你</div>
                              <div  class="dropdown account-drop">
                                ...
                                <ul class="dropdown-menu" style="z-index:10000" role="menu">
                                    ...
                                    <li ><a target="main"
						                  href="<%=SystemParam.getSiteRoot()%>/admin/modifypw.jsp">修改密码</a></li>
                                    <li><a target="main"
						                   href="<%=SystemParam.getSiteRoot()%>/admin/modifyinfo.jsp">编辑信息</a></li>
