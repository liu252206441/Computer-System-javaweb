...
<html>
	...
	<div class="search-title">
		...
		<div class="description">
			<a
				href="<%=SystemParam.getSiteRoot() %>/admin/friendlinkmanager.do?actiontype=load&seedid=208">新建友情链接</a>
		</div>
	</div>
	<!-- 搜索控件开始 -->
			...
			<c:forEach var="temfriendlink" items="${listfriendlink}">
				<tr>
					...
					<td><a class="orange-href"
						href="<%=SystemParam.getSiteRoot() %>/admin/friendlinkmanager.do?actiontype=load&id=${temfriendlink.id}&seedid=208">修改</a>
