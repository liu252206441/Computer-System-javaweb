...
<link
	href="<%=SystemParam.getSiteRoot()%>/webui/bootstrap/css/bootstrap.css"
	rel="stylesheet" />
<link
	href="<%=SystemParam.getSiteRoot()%>/webui/bootstrap/css/font-awesome.css"
	rel="stylesheet" />
<link rel="stylesheet"
	href="<%=SystemParam.getSiteRoot()%>/admin/css/login.css">

<script
	src="<%=SystemParam.getSiteRoot()%>/webui/jquery/jquery-1.12.4.min.js"></script>

<script
	src="<%=SystemParam.getSiteRoot()%>/webui/jquery/jquery.validate.min.js"
	type="text/javascript"></script>

<script
	src="<%=SystemParam.getSiteRoot()%>/webui/jquery/jquery.metadata.js"
	type="text/javascript"></script>
...
<body>
	<form method="post"
		action="<%=SystemParam.getSiteRoot()%>/admin/login.do" id="loginForm">
		...
		<div class="center-container">
			...
			<div class="login-container">
				...
				<div class="systitle"> 电脑销售信息管理系统</div>
